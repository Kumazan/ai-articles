...
[Open Console ↗](https://console.darkbloom.dev)
...
[Start Earning ↗](https://console.darkbloom.dev/earn)
...
- Gemma 4 26B, 4B active、快速的多模態 MoE, Input $0.03, Output $0.20, OpenRouter $0.40, 省 50%
- Qwen3.5 27B, Dense、前沿級推理, Input $0.10, Output $0.78, OpenRouter $1.56, 省 50%
- Qwen3.5 122B MoE, 10B active、最佳品質, Input $0.13, Output $1.04, OpenRouter $2.08, 省 50%
- MiniMax M2.5 239B, 11B active、SOTA coding, Input $0.06, Output $0.50, OpenRouter $1.00, 省 50%
...
[Download PDF ↗](https://github.com/Layr-Labs/d-inference/blob/master/papers/dginf-private-inference.pdf)
...
- Gemma 4 26B, Google 最新模型，快速的多模態 MoE，4B active params, text
- Qwen3.5 27B, Dense、前沿級推理（Claude Opus 蒸餾版）, text
- Qwen3.5 122B MoE ⓘ, 10B active, 每 token 最佳品質, text
- MiniMax M2.5 239B ⓘ, SOTA coding，11B active，Mac Studio 上 100 tok/s, text
- Cohere Transcribe, 2B conformer，語音轉文字的最佳選擇, audio
## 你可以怎麼看這件事
