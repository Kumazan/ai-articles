...
如果你還沒聽說過 OpenClaw——這是一個開源 AI 代理，標誌是一隻紅色螃蟹，是個安全噩夢，同時也是史上成長最快的開源專案。OpenClaw 成功的原因在於它是真正的個人代理：系統設計讓你可以透過 WhatsApp、Telegram 或 Slack 跟 AI 代理說話——就是你平常傳訊息的那些應用程式。你告訴它去查郵件、訂桌子、找個檔案，它就去你的電腦上做。它解決介面問題的方式，事後看來顯而易見：不是聊天機器人，不是命令列，而是讓你以對待真人的方式跟 AI 說話，用的是 WhatsApp 這種本來就極其熟悉的介面。
