...
**原文連結：** [OpenAI identifies security issue involving third-party tool, says user data was not accessed.](https://www.reuters.com/business/openai-identifies-security-issue-involving-third-party-tool-says-user-data-was-2026-04-11/)
...
OpenAI 說，這次事件觸發了其 GitHub Actions 工作流程去下載並執行惡意版本的 Axios。該流程能接觸到 macOS 應用的簽章與公證素材，包含 ChatGPT Desktop、Codex、Codex-cli 與 Atlas。公司也說，內部分析顯示，工作流程中的簽章憑證很可能沒有被惡意載荷成功外洩。5 月 8 日起，舊版 macOS 桌面 App 將不再獲得更新或支援，甚至可能無法正常運作。
...
換句話說，模型安全很重要，但它不是唯一的戰場。對真的在做 agent 和桌面端產品的人來說，這種事件比任何模型 demo 都更像現實世界，因為風險通常不是從前端跳出來，而是從安靜跑在背景裡的依賴鏈鑽進來。
