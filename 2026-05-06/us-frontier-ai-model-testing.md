---
title: "美國把 Google、Microsoft、xAI 的前沿模型納入國安測試"
description: "美國 CAISI 與 Google DeepMind、Microsoft、xAI 簽署協議，將在模型公開前做能力與國安風險測試，前沿 AI 監管正從事後追趕轉向預部署評估。"
date: 2026-05-06
...
- 美國商務部轄下的 Center for AI Standards and Innovation（CAISI）宣布與 Google DeepMind、Microsoft、xAI 簽署新協議。
- 這些協議會讓 CAISI 在模型公開前進行 pre-deployment evaluations，並做針對性的研究，以評估前沿 AI 能力與強化 AI security。
- 新協議延續先前與 OpenAI、Anthropic 的合作，但已依商務部長指示與 America's AI Action Plan 重新協商。
- CAISI 被指定為美國政府內部與 AI 產業互動的主要窗口，負責測試、共同研究與商業 AI 系統最佳實務發展。
- CAISI 至今已完成超過 40 次模型評估，其中包含仍未公開的 state-of-the-art models。
- 為了測試國安相關能力與風險，開發者常會提供降低或移除 safeguards 的模型，評估也可能在 classified environments 中進行。
- 這篇的重點不是單一公司配合監管，而是美國開始把前沿模型發布前測試制度化，尤其聚焦 cyber、bio、chemical 等高風險能力。
